...
void mac_frame_set_pan_ids_and_addresses_802_15_4_short(mac_frame_802_15_4_format_t *mac_frame_ptr, uint16_t dest_pan_id,
        uint64_t dest_addr, uint16_t src_pan_id, uint64_t src_addr)
{
    /*Doing this kind of assignment to support big/little Endian*/
    uint8_t   cnt;

    for (cnt=0;cnt<ADDR_SIZE;cnt++)
    {
    ...
    MAC_FRAME_SRC_PAN_ID_802_15_4(mac_frame_ptr, 0) = (uint8_t)src_pan_id;
    MAC_FRAME_SRC_PAN_ID_802_15_4(mac_frame_ptr,1)=(uint8_t)(src_pan_id>>8);
...
void get_src_and_dst_frame_addr_short(mac_frame_802_15_4_format_t *mac_frame_ptr, uint64_t *src, uint64_t *dst)
{
    ...
    *src=*dst=0;
    ...
    for (cnt1=0;cnt1<ADDR_SIZE;cnt1++)
    {
