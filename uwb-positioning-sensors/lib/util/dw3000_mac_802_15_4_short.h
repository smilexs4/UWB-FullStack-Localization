...
typedef struct
{
    ...
    uint8_t               dest_addr[ADDR_SIZE];
    uint8_t               src_pan_id[2];
    uint8_t               src_addr[ADDR_SIZE];
...
#define MAC_FRAME_SRC_PAN_ID_802_15_4(mac_frame_ptr,index)      (mac_frame_ptr)->mhr_802_15_4.src_pan_id[index]
...
void mac_frame_init_mac_frame_ctrl_short(mac_frame_802_15_4_format_t  *mac_frame_ptr);
void mac_frame_set_pan_ids_and_addresses_802_15_4_short(mac_frame_802_15_4_format_t   *mac_frame_ptr,uint16_t dest_pan_id,uint64_t dest_addr,uint16_t src_pan_id,uint64_t src_addr);
void mac_frame_update_sequence_number_short(mac_frame_802_15_4_format_t *mac_frame_ptr,uint8_t seq_num);
...
security_state_e get_security_state_short(mac_frame_802_15_4_format_t *mac_frame_ptr);
void get_src_and_dst_frame_addr_short(mac_frame_802_15_4_format_t *mac_frame_ptr,uint64_t *src, uint64_t *dst);
